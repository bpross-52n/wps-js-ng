...
export declare class ComplexDataInput implements DataInput {
    type: string;
    identifier: string;
    mimeType: string;
    schema: string;
     ...
     */
    constructor(identifier: string, mimeType: string, schema: string, encoding: string, asReference: boolean, complexPayload: any);
}
